...
bot = TeleBot(token='5638558040:AAEWVfCiS2rKnJaWml5Y5XYDY5o7J3TqQ2M', parse_mode='html') # создание бота
...
def start_command_handler(message: types.Message):
    ...
    bot.send_message(
        ...
        text='Привет! Я могу проверить твой JSON и переформатировать его для более удобного отображения\nОтправь мне свой JSON:', # текст сообщения
    )
